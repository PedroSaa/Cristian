...
namespace DocFlow.Application.Tests.Admin.CatalogosLegado.Commands.CrearSeFordoc;

public class CrearSeFordocCommandValidatorTests
{
    private readonly CrearSeFordocCommandValidator _validator = new();

    private static CrearSeFordocCommand BaseValid(int corrN = 0, string tipoDesc = "Formato de prueba", short tipoRec = 1, short tipoInt = 1)
        => new(
            TipoRec: tipoRec,
            TipoInt: tipoInt,
            TipoDesc: tipoDesc,
