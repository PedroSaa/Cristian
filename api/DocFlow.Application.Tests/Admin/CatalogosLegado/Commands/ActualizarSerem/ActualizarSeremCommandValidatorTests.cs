...
namespace DocFlow.Application.Tests.Admin.CatalogosLegado.Commands.ActualizarSerem;

public class ActualizarSeremCommandValidatorTests
{
    private readonly ActualizarSeremCommandValidator _validator = new();

    private static ActualizarSeremCommand BaseValid(
